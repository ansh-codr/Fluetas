  ...
  return (
    <div className="flex flex-col gap-5 max-w-6xl mx-auto w-full">
      ...
      <div className="fluetas-card p-5 sm:p-6 bg-gradient-to-r from-[#13161F] via-[#0E2433] to-[#0A1A24] border-[#38BDF8]/30 relative overflow-hidden">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <Link
            ...
            className="btn-primary bg-gradient-to-r from-[#38BDF8] to-[#0284C7] text-black text-xs px-4 py-2.5 flex items-center gap-2 shrink-0 self-stretch sm:self-auto justify-center font-bold no-underline shadow-[0_0_16px_rgba(56,189,248,0.3)]"
          >
            <Users size={14} />
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { label: 'Authorized Patients', value: patients.length.toString(), color: '#38BDF8', icon: Users, sub: 'Active consent granted' },
          { label: 'Today\'s Consultations', value: '2', color: '#10B981', icon: Calendar, sub: '1 upcoming at 4:30 PM' },
          { label: 'Pending Lab Reviews', value: '1', color: '#FBBF24', icon: FileText, sub: 'Blood panel & MRI' },
          { label: 'Follow-ups Due', value: '2', color: '#F472B6', icon: Clock, sub: 'Post-op & rehab progress' },
        ].map(stat => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        ...
        <div className="lg:col-span-2 flex flex-col gap-5">
          ...
          <div className="fluetas-card p-5">
            ...
            <div className="flex flex-col gap-3">
              {[
                { id: 'cons-1', patientName: 'Rahul Mehta', time: '04:30 PM (In 45 min)', reason: 'Rotator cuff impingement follow-up', type: 'Video Telehealth', status: 'Confirmed' },
                { id: 'cons-2', patientName: 'Priya Sharma', time: '06:00 PM', reason: 'Post-menstrual iron deficiency & fatigue', type: 'Video Telehealth', status: 'Scheduled' },
              ].map(item => (
                <div
                  key={item.id}
                  className="p-3.5 bg-[#0B0D14] border border-[#1E2133] rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3 hover:border-[#38BDF8]/40 transition-colors"
                >
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-[#38BDF8] to-[#0284C7] text-black font-bold flex items-center justify-center text-sm shrink-0">
                      {item.patientName[0]}
                    </div>
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        <span className="px-2 py-0.5 rounded text-[0.6rem] font-bold bg-[#10B981]/15 text-[#10B981]">
                          {item.status}
                        </span>
                      </div>
                  ...
                  <Link
                    href="/doctor/patients/patient_demo_rahul"
                    className="btn-primary bg-[#38BDF8] text-black hover:bg-[#38BDF8]/90 text-xs px-3.5 py-1.5 font-bold shrink-0 no-underline self-end sm:self-auto"
                  >
                    Open Workspace
                  </Link>
                </div>
          ...
          <div className="fluetas-card p-5">
            ...
            <div className="p-3.5 bg-[#0B0D14] border border-[#1E2133] rounded-xl flex items-center justify-between gap-3">
              <div className="flex items-center gap-3">
              ...
              <Link
                href="/doctor/reports"
                className="px-3.5 py-1.5 rounded-xl bg-[#FBBF24]/15 text-[#FBBF24] hover:bg-[#FBBF24]/25 border border-[#FBBF24]/30 text-xs font-bold shrink-0 no-underline transition-colors"
              >
                Review Report
              </Link>
            </div>
        ...
        {/* Right 1 Col: Quick Patient List & Follow-ups */}
            ...
            <div>
              ...
              {patients.length === 0 ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-[0.68rem] text-[#3A3F58] m-0 mt-1">
                    When customers book appointments with your profile, they appear here.
                  </p>
                </div>
              ) : (
                <div className="flex flex-col gap-2.5">
                  {patients.slice(0, 4).map(p => (
                    <Link
                      ...
                      className="p-2.5 rounded-xl bg-[#0B0D14] border border-[#1E2133] hover:border-[#38BDF8]/40 flex items-center justify-between text-xs text-[#E8EAF6] no-underline transition-colors"
                    >
                      <div className="flex items-center gap-2.5">
                        <div className="w-7 h-7 rounded-lg bg-[#38BDF8]/20 text-[#38BDF8] font-bold flex items-center justify-center text-xs">
                          {p.customerName[0]}
                        </div>
                        <span className="font-semibold">{p.customerName}</span>
                      </div>
                      <ChevronRight size={14} className="text-[#8B91B0]" />
                    </Link>
                  ))}
                </div>
              )}
            ...
            <div className="space-y-2.5 text-xs">
              <div className="p-3 bg-[#0B0D14] rounded-xl border border-[#1E2133]">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[0.62rem] text-[#F472B6] font-bold">In 3 days</span>
                </div>
              ...
              <div className="p-3 bg-[#0B0D14] rounded-xl border border-[#1E2133]">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className="text-[0.62rem] text-[#F472B6] font-bold">10 Sep 2026</span>
                </div>
                <p className="text-[0.7rem] text-[#8B91B0] m-0">
